...
function Mint() {
    ...
    // Function to trigger file input when clicking on NFT-image div
    ...
    const handleMintNFT = () => {
        ...
        if (!NFTname || !NFTdescription || !NFTprice || !image) {
        ...
        <div className="Mint-background">
            ...
            <div className="Mint">
                ...
                <div className="Mint-upload">
                    <div className="NFT-image" onClick={handleDivClick}>
                        <input 
                            type="file" 
                            ref={fileInputRef}
