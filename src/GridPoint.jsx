...
function GridPoint(){
    ...
    useEffect(() => {
        const fetchArtworks = async () => {
            try {
                ...
                // Get only 5 random items from the data
                const randomData = getRandomItems(transformedData, 5);
                setCollection(randomData);
            } catch (err) {
    ...
    return(
        <div className="secondDisplay">
            ...
            <div className="third-section">
                <div className="images-container">
                    <img src={display} alt="image" width={170} height={390}></img>
                    <img src={display2} alt="image" className="rotate" width={170} height={390}></img>
                </div>
                <div className="story">
                    <h2>Own Your Story, Digitalize Your Art.</h2>
                    <button className="NFT-button" onClick={() => navigate("/mint")}>Mint Your NFTs</button>
